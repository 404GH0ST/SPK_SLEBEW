...
class SPKDataSeeder extends Seeder
{
    ...
    {
        // 1. Create Criteria (matching K1-K6 from JS_SPK_Pertemuan 7 MARCOS.pdf)
        $criteriaData = [
            [
                'code' => 'K1',
        ...
        // 2. Create Alternatives (Nasabah 1-8 from PDF jobsheet task)
        $alternativesData = [
            [
                'code' => 'A1',
                'name' => 'Nasabah 1',
        ...
        // 3. Create Alternative Scores (from PDF jobsheet task)
        $scoresData = [
        ...
        // 4. Calculate and Seed SWARA Weights
        $swaraService = app(SwaraService::class);
        
        // Define expert importance ranking for SWARA
        $swaraItems = [
        ...
        // 5. Calculate and Seed MARCOS Results
        ...
        // 6. Log the Seed-based Calculation
